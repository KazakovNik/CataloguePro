...
resourcestring
  resHeapAdd = 'Добавили запись в кучу: ';
  resHeapClear = 'Очистка кучи';
  resHeapDelete = 'Удалили запись из кучи: ';
  resHeapFileNotFound = 'Файл не найден: ';
  resHeapLoadFile = 'Загрузили файл: ';
  ...
  resMainEditCurrentnodeTitle = 'Редактирование';
  resMainEditCurrentnodeCaption = 'Название:';
  ...
  resAboutCaption = 'О программе';
  resAboutVersion = 'Версия';
  resAboutCopyright = 'Казаков Николай Вадимович';

  resDialogNone = '&Отмена';
  resDialogAbort = 'Прервать';
  resDialogAll = '&Все';
  resDialogCancel = '&Отмена';
  resDialogIgnore = '&Игнорировать';
  resDialogNo = '&Нет';
  resDialogNoToAll = 'Нет всему';
  resDialogOk = '&Ok';
  resDialogRetry = '&Повторить попытку';
  resDialogYes = '&Да';
  resDialogYesToAll = 'Да всем';
  resDialogErrorTitle = 'Ошибка';
